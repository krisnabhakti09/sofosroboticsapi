...
func (h *userHandler) Delete(c *gin.Context) {
	...
	_, err = h.userService.Delete(finalIntNum)
	...
	response := helper.APIResponse("Successfully Delete User", http.StatusOK, "success", "")
...
func (h *userHandler) UpdateUser(c *gin.Context) {
	...
	newUserdata, err := h.userService.GetUserByID(input.ID)
	if err != nil {
		response := helper.APIResponse("Register account failed", http.StatusBadRequest, "error", nil)
		c.JSON(http.StatusBadRequest, response)
		return
		...
		newUserdata.Number = input.Number
		newUserdata.Number = input.Number

		newUser, err := h.userService.UpdateUser(newUserdata)
